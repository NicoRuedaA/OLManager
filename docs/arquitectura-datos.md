...
4. **start_new_game(team_id)**: Backend crea el mundo COMPLETO con todas las ligas/regiones y asigna el equipo del usuario

> **Nota**: `select_team()` ya no es necesario — el equipo ya viene asignado en `start_new_game`.
