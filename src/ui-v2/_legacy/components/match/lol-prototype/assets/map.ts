...
import fullWalls from "@/ui-v2/_legacy/components/match/lol-prototype/assets/lol_walls_full.json";
import type { LaneId, TeamId, Vec2 } from "@/ui-v2/_legacy/components/match/lol-prototype/engine/types";
